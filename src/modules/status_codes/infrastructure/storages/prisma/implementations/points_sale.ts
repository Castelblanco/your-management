...
export class StatusCodePointsSalePrismaOperations implements TStatusCodeOperations {
    db: typeof prisma.point_Sales_Status;
    wrappers: TWrappers<TStatusCodeDOM, TStatusCodeDAL>;

    constructor() {
        this.db = prisma.point_Sales_Status;
